...
uplink-hijack-beacon-desc = Это сигнальный маяк, разработанный Синдикатом для обхода системы защиты торговых аванпостов Nanotrasen. Для отключения защиты требуется 200 секунд, после чего торговый аванпост объявят о взломе, поэтому хорошо подготовьтесь.
