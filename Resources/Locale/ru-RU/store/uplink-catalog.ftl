...
uplink-clothing-shoes-boots-mag-syndie-name = Магнитные сапоги InteQ
...
uplink-stimpack-desc = Легендарный химический коктейль, производимый для InteQ. Одна инъекция этого вещества увеличивает скорость бега и позволяет быстрее восстанавливаться после оглушения в течение 30-ти секунд.
...
uplink-slipocalypse-clustersoap-desc = После приземления разбрасывает вокруг себя маленькие кусочки синдикат, которые испарятся сами через 60 секунд. InteQ почти потеряло его рецепт!
