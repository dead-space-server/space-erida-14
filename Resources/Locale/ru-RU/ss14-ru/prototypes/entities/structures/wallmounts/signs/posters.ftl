...
ent-PosterContrabandMissingGloves = Пропавшие перчатки
    .desc = Этот плакат описывает возмущение, возникшее после того, как Пакт сократила финансовые расходы на закупку изолирующих перчаток.
ent-PosterContrabandHackingGuide = Руководство по взлому
    .desc = Этот плакат подробно описывает внутреннюю работу стандартных воздушных шлюзов Пакта. К сожалению, он устарел.
...
ent-PosterContrabandPower = Мощь
    .desc = Плакат, который изображает власть за пределами Пакта.
...
ent-PosterContrabandRebelsUnite = Бунтари вместе
    .desc = Плакат, призывающий читателя восстать против Пакта.
...
ent-PosterContrabandEnlistGorlex = Идёт набор
    .desc = Вступайте в ряды Горлекса уже сегодня! Путешествуйте по галактике, убивайте контрактников, получайте деньги!
...
ent-PosterLegit50thAnniversaryVintageReprint = Винтажная перепечатка к 50-летнему юбилею
    .desc = Перепечатка плаката 2505 года, посвящённого 50-летию компании Nanoposters Manufacturing, дочерней компании Пакта.
ent-PosterLegitFruitBowl = Миска с фруктами
    .desc = Просто, но впечатляюще.
ent-PosterLegitPDAAd = Реклама КПК
    .desc = Плакат, рекламирующий новейшие КПК от поставщиков Пакта.
ent-PosterLegitEnlist = Вступай!
    .desc = Запишитесь в резерв эскадрона смерти Пакта сегодня!
