...
ent-BookEngineersHandbook = Справочник инженера
    .desc = Справочник по инженерному делу, подготовленный Пактом.
ent-BookScientistsGuidebook = Справочник учёного
    .desc = Путеводитель по миру науки, подготовленный Пактом.
ent-BookSecurity = Безопасность 101
    .desc = Книга о безопасности на станции, подготовленная Пактом. Книга испачкана кровью. Похоже, что её больше использовали как оружие, чем как учебное пособие.
...
ent-BookSpaceLaw = Корпоративный закон
    .desc = Набор правил Пакта для поддержания закона и порядка на своих космических станциях.
