...
ent-TraitorCodePaper = кодовое слово InteQ
    .desc = Раскрытое кодовое слово, с помощью которого можно связаться с InteQ.
ent-AllTraitorCodesPaper = реестр кодовых слов InteQ
    .desc = Реестр всех активных кодовых слов InteQ.
    .suffix = Адмемы
