...
ent-WeaponLaserCarbine = лазерный карабин
    .desc = Предпочитается службой безопасности Пакта за дешевизну и простоту использования.
    .suffix = Винтовка
...
ent-WeaponPulsePistol = импульсный пистолет
    .desc = Новейший энергетический пистолет, предпочитаемый оперативниками Пакта в качестве запасного оружия.
    .suffix = Пистолет
ent-WeaponPulseCarbine = импульсный карабин
    .desc = Высокотехнологичный энергетический карабин, который предпочитают оперативники ОБР Пакта.
    .suffix = Винтовка
...
ent-WeaponDisablerPractice = тренировочный станнер
    ...
    .suffix = Пистолет
ent-SimplifiedTaser = упрощенный тазер 
    .desc = электрошокер, используемый службой безопасности для подавления целей на расстоянии.
    .suffix = Пистолет
ent-WeaponTaser = тазер
    .desc = Электрошокер, используемый центральным командованием для подавления целей на расстоянии.
    .suffix = Пистолет
