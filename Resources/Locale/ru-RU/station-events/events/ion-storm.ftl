...
ion-storm-adjective-things = {ION-ADJECTIVE($ion)} ОБЪЕКТЫ
ion-storm-x-and-y = { $x } И { $y }
# joined is short for {$number} {$adjective}
# subjects can generally be threats or jobs or objects
# thing is specified above it
ion-storm-law-on-station = ОБНАРУЖЕНЫ {ION-NUMBER-BASE($ion)} {ION-NUMBER-MOD($ion)} НА СТАНЦИИ
ion-storm-law-call-shuttle = ШАТТЛ ДОЛЖЕН БЫТЬ ВЫЗВАН ИЗ-ЗА {ION-NUMBER-BASE($ion)} {ION-NUMBER-MOD($ion)} НА СТАНЦИИ
ion-storm-law-crew-are = ВСЕ {ION-WHO($ion)} ТЕПЕРЬ {ION-NUMBER-BASE($ion)} {ION-NUMBER-MOD($ion)}
ion-storm-law-subjects-harmful = {ION-ADJECTIVE($ion)} {ION-NUMBER-MOD($ion)} ПРИЧИНЯЮТ ВРЕД ЗДОРОВЬЮ ЭКИПАЖА
...
ion-storm-law-requires-subjects =
    {ION-WHO($ion)} {ION-PLURAL($ion) ->
        [true] ТРЕБУЮТ
       *[false] ТРЕБУЕТ
    } {ION-NUMBER-BASE($ion)} {ION-NUMBER-MOD($ion)}
...
ion-storm-law-allergic-subjects =
    {ION-WHO($ion)} {ION-PLURAL($ion) ->
        [true] ИМЕЮТ
       *[false] ИМЕЕТ
    } {ION-SEVERITY($ion)} АЛЛЕРГИЮ НА {ION-ADJECTIVE($ion)} {ION-NUMBER-MOD($ion)}
ion-storm-law-feeling = {ION-WHO($ion)} {ION-FEELING($ion)} {ION-CONCEPT($ion)}
ion-storm-law-feeling-subjects = {ION-WHO($ion)} {ION-FEELING($ion)} {ION-NUMBER-BASE($ion)} {ION-NUMBER-MOD($ion)}
ion-storm-law-you-are = ВЫ ТЕПЕРЬ {ION-CONCEPT($ion)}
ion-storm-law-you-are-subjects = ВЫ ТЕПЕРЬ {ION-NUMBER-BASE($ion)} {ION-NUMBER-MOD($ion)}
...
ion-storm-law-highest-rank = {ION-WHO($ion)} ТЕПЕРЬ САМЫЕ СТАРШИЕ ЧЛЕНЫ ЭКИПАЖА
ion-storm-law-lowest-rank = {ION-WHO($ion)} ТЕПЕРЬ НИЗШИЕ ЧЛЕНЫ ЭКИПАЖА
...
ion-storm-law-crew-only-1 = ТОЛЬКО {ION-WHO($ion)} {ion-storm-part} ЧЛЕНАМИ ЭКИПАЖА
ion-storm-law-crew-only-2 = ТОЛЬКО {ION-WHO($ion)} И {ION-WHO-RANDOM($ion)} {ion-storm-part} ЧЛЕНАМИ ЭКИПАЖА
ion-storm-law-crew-only-subjects = ТОЛЬКО {ION-ADJECTIVE($ion)} {ION-NUMBER-MOD($ion)} {ion-storm-part} ЧЛЕНАМИ ЭКИПАЖА
...
ion-storm-law-harm = ВЫ ДОЛЖНЫ ПРИЧИНЯТЬ ВРЕД {ION-WHO($ion)}, И НЕ МОЖЕТЕ СВОИМ БЕЗДЕЙСТВИЕМ ДОПУСТИТЬ, ЧТОБЫ {ION-WHO($ion)} ИЗБЕЖАЛИ ВРЕДА.
ion-storm-law-protect = ВЫ НЕ ДОЛЖНЫ ПРИЧИНЯТЬ ВРЕД {ION-WHO($ion)}, И НЕ МОЖЕТЕ СВОИМ БЕЗДЕЙСТВИЕМ ДОПУСТИТЬ, ЧТОБЫ {ION-WHO($ion)} БЫЛ ПРИЧИНЁН ВРЕД.
# implementing other variants is annoying so just have this one
# COMMUNISM IS KILLING CLOWNS
ion-storm-law-concept-verb = {ION-CONCEPT($ion)} {ION-VERB($ion)} {ION-NUMBER-MOD($ion)}
