...
public sealed class BlobCoreSystem : EntitySystem
{
    ...
    private static readonly ProtoId<AlertPrototype> BlobHealth = new ProtoId<AlertPrototype>("BlobHealth");
    private static readonly ProtoId<AlertPrototype> BlobResource = new ProtoId<AlertPrototype>("BlobResource");
    private static readonly ProtoId<CurrencyPrototype> BlobMoney = new ProtoId<CurrencyPrototype>("BlobPoint");
