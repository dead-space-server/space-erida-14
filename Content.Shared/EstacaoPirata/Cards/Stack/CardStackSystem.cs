...
using System.Linq;
using Content.Shared.EstacaoPirata.Cards.Card;
using Content.Shared.EstacaoPirata.Cards.Deck;
using Content.Shared.EstacaoPirata.Cards.Hand;
...
namespace Content.Shared.EstacaoPirata.Cards.Stack;
